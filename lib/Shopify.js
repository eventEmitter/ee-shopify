	...
	module.exports = new Class({
		...
		, init: function init(options) {
            ...
            if (type.string(options.token) && options.token.trim()) {
                ...
                Class.define(this, 'key', Class(options.key));
                Class.define(this, 'secret', Class(options.secret));
        ...
        , _getErrorMessage: function(data) {
            ...
            if (responseData) {
                if (type.string(responseData.error)) return {message: responseData.error, data: responseData};
